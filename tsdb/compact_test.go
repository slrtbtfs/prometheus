...
// See https://github.com/slrtbtfs/prometheus/issues/3064
...
func TestCompaction_populateBlock(t *testing.T) {
	var populateBlocksCases = []struct {
		...
		{
			// Introduced by https://github.com/slrtbtfs/prometheus/tsdb/issues/347.
		...
		{
			// Introduced by https://github.com/slrtbtfs/prometheus/tsdb/pull/539.
